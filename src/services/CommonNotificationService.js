...
export async function sendJoinSchemeNotification(schemeId, amount, schemeName) {
  try {
    ...
    let message = "";
    let imageUrl = "https://tse2.mm.bing.net/th/id/OIP.HZcuqG_YpD6NqjorfHWx5wHaHa?w=768&h=768&rs=1&pid=ImgDetMain&o=7&rm=3";
    ...
    switch (schemeId) {
      case 1: // Monthly Installment
        ...
        imageUrl = "https://www.pngall.com/wp-content/uploads/5/Gold-Jewels-PNG-Free-Image.png";
        break;
      ...
      case 2: // Multiple Payment
        ...
        imageUrl = "https://tse1.mm.bing.net/th/id/OIP.f67hGJz0sNHqCWwTGcv6DgHaHa?w=600&h=600&rs=1&pid=ImgDetMain&o=7&rm=3";
        break;
      ...
      case 3: // Fixed Deposit
        ...
        imageUrl = "https://media.istockphoto.com/photos/indian-jewellery-picture-id486592060?k=20&m=486592060&s=612x612&w=0&h=6_VWcfgKq6TOf-d9W2CJ5YnHFiCbLDizjNefcUAnMcU=";
        break;
